...
class Kamiwaza < Formula
  ...
  if ENV["HOMEBREW_KAMIWAZA_LOCAL_BUILD"]
    ...
    sha256 "b54e24b447280556ca540e05ae24da9410e89c54f1e0f69b0c4fbc98aafff1c9"
  else
    ...
    sha256 "b54e24b447280556ca540e05ae24da9410e89c54f1e0f69b0c4fbc98aafff1c9"  # This will be updated by the build process
  end
  ...
  service do
    run [opt_bin/"kamiwaza", "start"]
    keep_alive true
    log_path var/"log/kamiwaza/kamiwaza-service.log"
    error_log_path var/"log/kamiwaza/kamiwaza-service-error.log"
    environment_variables KAMIWAZA_ROOT: opt_libexec,
